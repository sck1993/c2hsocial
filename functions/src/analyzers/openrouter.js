 ...
 * @param {Array}       opts.posts                    - postsWithInsights 배열 (최근 2주 포스트)
 * @param {number|null} opts.accountAvgEngagementRate - 최근 14일 평균 참여율
...
계정의 최근 2주 게시물 전체 성과 데이터를 종합 분석하고, 아래 세 항목으로 나누어 각 2~3문장씩 구체적인 수치 근거를 포함해 작성하세요.
...
- 최근 14일 평균 참여율: ${accountAvgEngagementRate != null ? accountAvgEngagementRate + "%" : "—"}

최근 2주 게시물 성과 지표 (${(posts || []).length}건):
${postLines || "  (포스트 없음)"}`;
